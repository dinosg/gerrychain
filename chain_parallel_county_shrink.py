...
#    exec(open("input_templates/PA_CD_2011_SEN12_countyloop.py").read()) 
    #exec(open("input_templates/PA_districtr17.py").read()) 
#    
    exec(open("input_templates/OH_CD_SEN16_2000.py").read()) 
    ...
    if dontfeedin == 0 or not( 'graph_PA' in globals()):
        ...
        #comment out code dealing with case the file is a .json
        #if your map was saved as a .json you BETTER FIX THE ISLANDS AGAIN AND HAVE
        #CODE FOR JOINING THEM EVERY TIME
    """    
