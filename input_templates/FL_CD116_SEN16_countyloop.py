...
my_apportionment = "cCCD16"    #type of district boundaries to calculate - eg US congressional, state senate, house etc.
...
my_electiondatafile ="./shapefiles_multistate/FL-shapefiles-master/ramsay_shapefilesFL/vtd_alldata/vtd_alldata_cCD116_big.json"
state = "FL"
#for Ramsay's file on vtds including pop (but no election results)
maxsplitlist=[70,50, 40,35 ]
cutedgemaxlist  = [2,2,2,1.2]
poptol=0.02
