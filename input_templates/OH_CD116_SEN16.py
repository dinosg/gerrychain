...
my_apportionment = "CD116"    #type of district boundaries to calculate - eg US congressional, state senate, house etc.
...
my_electiondatafile ="./shapefiles_multistate/OH_precincts/ohio_test.json"
state = "OH"
